...
- Generated UTC: 2026-09-05T07:41:22Z
- Source commit: 5eeecf3e571dba499e2b2c5f8d89b8ecb4ef9f2c
- Mode: PAPER
...
## Service
```text
{"status":"degraded","strategy":"Volume Strategy FINAL Universal v15","symbols":2,"errors":["RuntimeError: mobile relay is stale: age=898729.1s max=90s","RuntimeError: mobile relay is stale: age=898729.4s max=90s"],"live_halted":[]}
...
## HTTP checks
```text
http://127.0.0.1:8000/health 200 {"status":"degraded","strategy":"Volume Strategy FINAL Universal v15","symbols":2,"errors":["RuntimeError: mobile relay is stale: age=898729.1s max=90s","RuntimeError: mobile relay is stale: age=898729.4s max=90s"],"live_halted":[]}
