...
- Generated UTC: 2026-09-03T01:12:58Z
- Source commit: cb11e48dd8aa7b602621c87548edf40e953a790e
- Mode: PAPER
...
## Service
```text
{"status":"degraded","strategy":"Volume Strategy FINAL Universal v15","symbols":2,"errors":["RuntimeError: mobile relay is stale: age=702625.9s max=90s","RuntimeError: mobile relay is stale: age=702626.1s max=90s"],"live_halted":[]}
...
## HTTP checks
```text
http://127.0.0.1:8000/health 200 {"status":"degraded","strategy":"Volume Strategy FINAL Universal v15","symbols":2,"errors":["RuntimeError: mobile relay is stale: age=702625.9s max=90s","RuntimeError: mobile relay is stale: age=702626.1s max=90s"],"live_halted":[]}
