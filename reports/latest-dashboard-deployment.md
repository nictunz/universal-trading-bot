...
- Generated UTC: 2026-09-02T10:24:16Z
- Source commit: 07ab83587379fa07951ed16d51459efa4c816362
- Mode: PAPER
...
## Service
```text
{"status":"degraded","strategy":"Volume Strategy FINAL Universal v15","symbols":2,"errors":["RuntimeError: mobile relay is stale: age=649304.7s max=90s","RuntimeError: mobile relay is stale: age=649304.9s max=90s"],"live_halted":[]}
...
## HTTP checks
```text
http://127.0.0.1:8000/health 200 {"status":"degraded","strategy":"Volume Strategy FINAL Universal v15","symbols":2,"errors":["RuntimeError: mobile relay is stale: age=649304.7s max=90s","RuntimeError: mobile relay is stale: age=649304.9s max=90s"],"live_halted":[]}
