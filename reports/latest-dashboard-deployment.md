...
- Generated UTC: 2026-09-02T22:36:49Z
- Source commit: 233c230fb3565f3321748f81e5fb0501dde73c56
- Mode: PAPER
...
## Service
```text
{"status":"degraded","strategy":"Volume Strategy FINAL Universal v15","symbols":2,"errors":["RuntimeError: mobile relay is stale: age=693255.2s max=90s","RuntimeError: mobile relay is stale: age=693255.4s max=90s"],"live_halted":[]}
...
## HTTP checks
```text
http://127.0.0.1:8000/health 200 {"status":"degraded","strategy":"Volume Strategy FINAL Universal v15","symbols":2,"errors":["RuntimeError: mobile relay is stale: age=693255.2s max=90s","RuntimeError: mobile relay is stale: age=693255.4s max=90s"],"live_halted":[]}
