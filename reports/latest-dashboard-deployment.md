...
- Generated UTC: 2026-09-06T10:13:05Z
- Source commit: 223077baa975207ca0900ce980e26929f2c47739
- Mode: PAPER
...
## Service
```text
{"status":"degraded","strategy":"Volume Strategy FINAL Universal v15","symbols":2,"errors":["RuntimeError: mobile relay is stale: age=994233.7s max=90s","RuntimeError: mobile relay is stale: age=994233.9s max=90s"],"live_halted":[]}
...
## HTTP checks
```text
http://127.0.0.1:8000/health 200 {"status":"degraded","strategy":"Volume Strategy FINAL Universal v15","symbols":2,"errors":["RuntimeError: mobile relay is stale: age=994233.7s max=90s","RuntimeError: mobile relay is stale: age=994233.9s max=90s"],"live_halted":[]}
