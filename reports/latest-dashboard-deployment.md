...
- Generated UTC: 2026-08-28T08:55:51Z
- Source commit: 32f5944e40a25af52fba9de24c92cfdfa11e61c4
- Mode: PAPER
...
## Service
```text
{"status":"degraded","strategy":"Volume Strategy FINAL Universal v15","symbols":2,"errors":["RuntimeError: mobile relay is stale: age=212003.9s max=90s","RuntimeError: mobile relay is stale: age=212004.2s max=90s"],"live_halted":[]}
...
## HTTP checks
```text
http://127.0.0.1:8000/health 200 {"status":"degraded","strategy":"Volume Strategy FINAL Universal v15","symbols":2,"errors":["RuntimeError: mobile relay is stale: age=212003.9s max=90s","RuntimeError: mobile relay is stale: age=212004.2s max=90s"],"live_halted":[]}
