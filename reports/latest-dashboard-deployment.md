...
- Generated UTC: 2026-09-07T19:50:06Z
...
http://127.0.0.1:8000/api/state 200 {"strategy":"Volume Strategy FINAL Universal v15","symbols":[{"symbol":"BTC/USDT:USDT","timeframe":"15m","timestamp":"2026-09-07T19:30:00+00:00","position":{"side":null,"size":0.0,"entry":null,"tp":null,"sl":null,"entries":0},"signal":null,"signal_reason":"NO_SIGNAL","values":{"strategy":"Volume Strategy FINAL Universal v15","version":"v15","volume_ratio":1.215990878236366,"volume_break":false,"one_bar_volatility":0.12309751216771563,"one_bar_min":0.1,"one_bar_max":3.6,"one_bar_ok":true,"nbar_range":1.2365725388073974,"nbar_bars":36,"nbar_block_range":2.4202490183712007,"nbar_block_bars":200,"nbar_max_allowed":6.3,"nbar_ok":true,"nbar_blocked":false,"adx":28.402063781340377,"adx_min":11.6,"a
...
## Socket
```text
LISTEN 0      2048       127.0.0.1:8000       0.0.0.0:*    users:(("python",pid=293680,fd=14))
```
