...
PUBLIC_DASHBOARD_URL = "http://34.132.172.40:8000/"
PUBLIC_STRATEGY_URL = "http://34.132.172.40:8000/strategy"


def install_dashboard_navigation(app: FastAPI) -> None:
    """Inject a small canonical navigation bar into the main dashboard.

    The links use same-origin paths so they continue to work through local
    forwarding or a future reverse proxy, while the canonical public address
...
<div class='bar' style='display:flex;flex-wrap:wrap;gap:8px;align-items:center;justify-content:space-between'>
  <div>
    <b>고정 대시보드</b>
    <div class='muted' style='margin-top:3px'>http://34.132.172.40:8000/</div>
  </div>
  <div class='row'>
