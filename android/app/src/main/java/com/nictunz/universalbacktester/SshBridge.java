...
public final class SshBridge {
    ...
    public static final class RelayClient implements AutoCloseable {
        ...
        public synchronized void uploadTextAtomic(String remotePath, String text) throws Exception {
            ...
            // Keep the old complete snapshot visible until the new upload is complete.
            // temp and destination are in the same server directory/filesystem, so
            // Linux rename-over is atomic: readers observe old-or-new, never missing.
